...
class ThreadClient(threading.Thread):
    ...
    def listen_messages(self):
        while True:
            ...
            if message == "exit":
                print(f"clent {self.id} s'est déconnecté-é")
                break
...
def main():
    ...
    sckt_cl2.close()
        ...
        # client_msg = sckt_cl1.recv(1024)
        # print(f"cl1: {str(client_msg,'utf-8')}")
        # client_msg = sckt_cl2.recv(1024)
        # print(f"cl2: {str(client_msg,'utf-8')}")
